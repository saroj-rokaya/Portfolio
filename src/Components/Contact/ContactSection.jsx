...
const ContactSection = () => {
  return (
    <>
      <section className=" body-font  relative bg-[#011222]">
        {/* <Successbar/> */}
        <div className=" w-full lg:container px-5 py-20 mx-auto md:gap-5 flex md:flex-nowrap flex-wrap">
          {/* map section */}
          <div className="lg:w-3/5 md:w-1/2 w-full h-[70vh] md:h-screen bg-gray-200  rounded-lg overflow-hidden p-10 flex items-end justify-start relative">
            <iframe
              width="100%"
              height="100%"
            ...
            />
            <div className="bg-[#011222] mx-auto text-white relative flex flex-wrap py-6 rounded-lg shadow-md">
